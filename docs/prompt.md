...
If a feature is properly implemented and it is a pass merge the work to the main and push the code. Make the sure the branch is not visible on the main github but only locally.
