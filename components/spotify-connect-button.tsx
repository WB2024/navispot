...
export function SpotifyConnectButton() {
  ...
  return (
    <button
      onClick={handleLogin}
      disabled={isLoading}
      className="flex h-10 items-center justify-center gap-2 rounded-full bg-[#1DB954] px-6 text-sm font-semibold text-white transition-colors hover:bg-[#1ed760] disabled:opacity-50 disabled:hover:bg-[#1DB954] hover:cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#1DB954] focus:ring-offset-2 dark:focus:ring-offset-zinc-900"
    >
